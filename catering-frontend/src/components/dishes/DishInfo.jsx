...
const DishInfo = () => {
  ...
  useEffect(() => {
    api
      .get(`api/dish/${category_slug}/${product_slug}`)
      .then((res) => {
  ...
  const isInCart =
    (dishInCart[dish.id] ||
      (localStorage.getItem(`cart_item_id_${dish.name}`) ?? false)) ??
    false;
    ...
    <>
          ...
          <div className="">
            <div className="row gx-4">
              ...
              <div className="col-md-6">
                <h1 className="poppins-bold pt-4 pt-md-0">{dish.name}</h1>
                <h3
                  className="lato-bold"
      ...
      <section>
        <div className="header bg-light d-inline-block ms-md-3 nav-tab">
          <ul
            className="nav nav-pills nav-tablist"
            id="pills-tab"
            role="tablist"
            style={{ background: "hsl(20 5.9% 90%)", padding: "0.2rem" }}
          >
        ...
        <div
          className="tab-content ms-md-3 reviewtab"
          id="pills-tabContent"
          style={{ width: "95%" }}
        >
          <div
