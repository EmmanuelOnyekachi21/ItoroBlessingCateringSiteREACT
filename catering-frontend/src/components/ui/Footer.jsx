  ...
  return (
    <footer className='text-white pt-5 pb-3' style={{ backgroundColor: '#111827' }}>
      <div className="px-3">
        <div className="row mx-auto border border-danger">
          ...
          <div className="col-12 col-md-6 mb-4 col-lg-3">
            ...
            <div className="d-flex w-50 gap-3">
              <a href="#" className="footer-link fs-3">
            ...
            <div className="mb-3 text-start">
              <ul className="navbar-nav fs-5 d-flex flex-column text-white">
                <li className="nav-item poppins-regular">
                  <a className="nav-link d-inline-block footer-link" href="/">Home</a>
                </li>
                <li className="nav-item poppins-regular">
                  <a className="nav-link d-inline-block footer-link" href="/menu">Menu</a>
                </li>
                <li className="nav-item poppins-regular">
                  <a className="nav-link d-inline-block footer-link" href="/catering">Catering</a>
                </li>
                <li className="nav-item poppins-regular">
                  <a className="nav-link d-inline-block footer-link" href="/gallery">Gallery</a>
                </li>
                <li className="nav-item poppins-regular">
                  <a className="nav-link d-inline-block footer-link" href="/about">About</a>
                </li>
                <li className="nav-item poppins-regular">
                  <a className="nav-link d-inline-block footer-link" href="/contact">Contact</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="col-12 col-md-6 mb-4 col-lg-3">
            ...
            <div className="mb-3 text-start">
              <div className='d-flex gap-2 align-items-start mb-3'>
                <MapPin size={48} />
                <span className='fs-4'>Shop 10, Isheri Estate, Opic, Ogun State</span>
              </div>
              <div className='d-flex gap-2 align-items-start mb-3'>
                <Phone size={36} />
                <a href="tel:+2348024620183" className='fs-4 footer-link'>+234 802 462 0183</a>
              </div>
              <div className="d-flex gap-2 align-items-start">
                <Mail size={32} />
                <a href="mailto:info@itoroeats.com" className='fs-4 footer-link'>info@itoroeats.com</a>
              </div>
            </div>
          </div>
        ...
        <div className="border-top border-secondary mt-5 pt-3 text-center text-secondary">
          <p>&copy; {new Date().getFullYear()} Itoro Eats & Events. All rights reserved.</p>
        </div>
      </div>
